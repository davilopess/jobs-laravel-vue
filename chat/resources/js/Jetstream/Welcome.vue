<template>
    <div>
        <div class="grid grid-cols-12">
            <div class="grid col-span-4 content-center justify-center">
                <img class="h-48" src="images/image-default.jpg" alt="">
            </div>
            <div class="col-span-8 p-3 sm:px-10 bg-white border-b border-gray-200">
